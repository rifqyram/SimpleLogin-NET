...
public interface IRepository<TEntity>
{
    ...
    Task<TEntity> FindAsyncOrElse(Expression<Func<TEntity, bool>> criteria, Func<Task<TEntity>> func);
    Task<TEntity> FindAsyncOrElse(Expression<Func<TEntity, bool>> criteria, string[] includes, Func<Task<TEntity>> func);
