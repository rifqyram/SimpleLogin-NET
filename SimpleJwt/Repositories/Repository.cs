...
public class Repository<TEntity> : IRepository<TEntity> where TEntity : class
{
    ...
    public async Task<TEntity> FindAsyncOrElse(Expression<Func<TEntity, bool>> criteria, Func<Task<TEntity>> func)
    {
        var entity = await _context.Set<TEntity>().FirstOrDefaultAsync(criteria);
        return entity ?? await func();
    }

    public async Task<TEntity> FindAsyncOrElse(Expression<Func<TEntity, bool>> criteria, string[] includes,
